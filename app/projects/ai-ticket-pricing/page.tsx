...
export const metadata = {
  title: "AI Dynamic Ticket Pricing | Ogbebor Osaheni",
  description: "CMA-compliant AI pricing engine for UK live events. XGBoost + SHAP explainability. R² = 0.79.",
  openGraph: {
    title: "AI Dynamic Ticket Pricing | Ogbebor Osaheni",
    description: "CMA-compliant AI pricing engine for UK live events. XGBoost + SHAP explainability. R² = 0.79.",
    url: "https://osaheniogbebor.com/projects/ai-ticket-pricing",
    images: [{ url: "https://osaheniogbebor.com/og-image.jpg", width: 1200, height: 630, alt: "AI Dynamic Ticket Pricing — Ogbebor Osaheni" }],
    type: "website",
  },
  twitter: {
