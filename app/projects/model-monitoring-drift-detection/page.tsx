    ...
    <section id="pipeline-diagram" className="py-20 px-4 bg-slate-50 dark:bg-jungle-900/30">
      <div className="container mx-auto max-w-6xl space-y-10">
        ...
        <div className="flex justify-center overflow-x-auto">
          ...
          >
            {/* Main pipeline boxes: x=160, width=200, centre x=260 */}
            {/* Left feedback path goes to x=100; label at x=55 clears the line */}
            {/* Right side box: x=395, width=200                                */}
            ...
            />
            {/* Label centred at x=55 — right edge ≈85, clears the x=100 line */}
            <text x="55" y="337" textAnchor="middle"
              className="fill-amber-600 dark:fill-amber-400"
              fontSize="10"
            >retrain loop</text>
